  ...
  return (
    <div className="rounded-lg bg-white p-4 shadow mt-4">
      ...
      <div className="text-gray-400 text-xs mt-1">
        ...
        {left ||
          "Minima quidem omnis saepe nihil at earum, officiis ea laboriosam illum debitis."}
      </div>
      <button className="p-1 px-2 text-sm text-gray-600 bg-gray-100 mt-2 w-full rounded">
        Learn more
      </button>
    </div>
  );
